...
for i in range(len(transect_labels)):
    hist_data_path = 'F:/XBeach/Tuvalu/1D_sims/Nui/t_'+str(transect_labels[i])+'_base/hist_and_ext_data.mat'
    training_data_path = 'F:/XBeach/Tuvalu/1D_sims/Nui_forecast/t_'+str(transect_labels[i])+'_results.csv'
    rbf_coeff_path = 'F:/XBeach/Tuvalu/1D_sims/Nui_forecast/t_'+str(transect_labels[i])+'_rbf_coefficients_max_TWL_and_inun_ext.pkl'
    output_thresholds_path = 'F:/XBeach/Tuvalu/1D_sims/Nui_forecast/t_'+str(transect_labels[i])+'_thresholds.csv'
