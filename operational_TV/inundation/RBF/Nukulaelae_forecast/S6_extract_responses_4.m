...
for i = 4:6:length(transect_labels)
    ...
    for j = 1:length(subset)
        ...
        try
            ...
            run_path = '/scale_wlg_nobackup/filesets/nobackup/spc03223/TCAP/Forecast/Nukulaelae_forecast/Failed_runs_4/';
...
run_path = '/nesi/nobackup/spc03223/TCAP/Forecast/Nukulaelae_forecast/Failed_runs_4';
