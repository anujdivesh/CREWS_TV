...
%%
fff = 0;
for i = 271+6:6:length(transect_labels)
    dirName1 = [base_path '/t_' num2str(t{i}.label) '_base'];
    load([dirName1 '/centroid.mat']);
    dist = t{i}.dist';
    dist = -dist';
    ...
    for j = 1:length(subset)
        ...
        try
            ...
            run_path = '/scale_wlg_nobackup/filesets/nobackup/spc03223/TCAP/Forecast/Nukulaelae_forecast/Failed_runs_1/';
...
run_path = '/nesi/nobackup/spc03223/TCAP/Forecast/Nukulaelae_forecast/Failed_runs_1';
