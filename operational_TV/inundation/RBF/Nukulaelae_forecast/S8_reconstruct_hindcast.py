...
os.chdir('G:/XBeach/Tuvalu/1D_sims/Nukulaelae_forecast/Nukulaelae_forecast/')

transects_csv = 'G:/XBeach/Tuvalu/1D_sims/Nukulaelae_forecast/Nukulaelae_forecast/Nukulaelae/Nukulaelae_Oceanside_Profilesv4.csv'
...
for i in range(len(transect_labels)):
    hist_data_path = 'F:/XBeach/Tuvalu/1D_sims/Nukulaelae/t_'+str(transect_labels[i])+'_base/hist_and_ext_data.mat'
    training_data_path = 'G:/XBeach/Tuvalu/1D_sims/Nukulaelae_forecast/Nukulaelae_forecast/t_'+str(transect_labels[i])+'_results.csv'
    rbf_coeff_path = 'G:/XBeach/Tuvalu/1D_sims/Nukulaelae_forecast/Nukulaelae_forecast/t_'+str(transect_labels[i])+'_rbf_coefficients_max_TWL_and_inun_ext.pkl'
    output_thresholds_path = 'G:/XBeach/Tuvalu/1D_sims/Nukulaelae_forecast/Nukulaelae_forecast/t_'+str(transect_labels[i])+'_thresholds.csv'
