...
%%
fff = 0;
for i = 1:53%length(transect_labels)
    ...
    for j = 1:length(subset)
        ...
        try
            ...
            run_path = '/scale_wlg_nobackup/filesets/nobackup/spc03223/TCAP/Forecast/Nanumea_forecast/Failed_runs_1/';
...
fid  = fopen('Failed_runs_1/run_all_models.sh','w');
for j = 1:fff
