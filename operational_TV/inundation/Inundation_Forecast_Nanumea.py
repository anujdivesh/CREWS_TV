...
def inundation_forecast(now):
    ...
    fl_name_tides = '../tmp/tide_hourly_Nanumea.nc'
    fl_name_tides_min = '../tmp/tide_minute_Nanumea.nc'
    fl_name_sla = '../tmp/sla_hourly_Nanumea.nc'
    ...
    transects_csv = '../inundation/RBF/Nanumea_forecast/Nanumea/Nanumea_Merged_Profilev4.csv'
    ...
    for tt in range(len(transect_labels)):
        fig_outfile_name = '../inundation/Figures/Nanumea_t_' + str(transect_labels[tt]) + '_forecast.png'
        risk_outfile_name = '../inundation/Flood_risk/Nanumea_t_' + str(transect_labels[tt]) + '_risk_level.csv'
        
        coordinate_fl = '../inundation/RBF/Nanumea_forecast/t_' + str(transect_labels[tt]) + '_coordinates.csv'
        training_data_path = '../inundation/RBF/Nanumea_forecast/t_' + str(transect_labels[tt]) + '_results.csv'
        rbf_coeff_path = '../inundation/RBF/Nanumea_forecast/t_' + str(transect_labels[tt]) + '_rbf_coefficients_max_TWL_and_inun_ext.pkl'
        thresholds_path = '../inundation/RBF/Nanumea_forecast/t_' + str(transect_labels[tt]) + '_thresholds.csv'
