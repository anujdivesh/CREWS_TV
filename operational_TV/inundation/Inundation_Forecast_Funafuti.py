...
def inundation_forecast(now):
    ...
    fl_name_tides = '../tmp/tide_hourly_Fongafale.nc'
    fl_name_tides_min = '../tmp/tide_minute_Fongafale.nc'
    fl_name_sla = '../tmp/sla_hourly_Fongafale.nc'
    ...
    transects_csv = '../inundation/RBF/Funafuti_forecast/Funafuti/Funafuti_Oceanside_Profilesv4.csv'
    ...
    for tt in range(len(transect_labels)):
        fig_outfile_name = '../inundation/Figures/Funafuti_t_' + str(transect_labels[tt]) + '_forecast.png'
        risk_outfile_name = '../inundation/Flood_risk/Funafuti_t_' + str(transect_labels[tt]) + '_risk_level.csv'
        
        coordinate_fl = '../inundation/RBF/Funafuti_forecast/t_' + str(transect_labels[tt]) + '_coordinates.csv'
        training_data_path = '../inundation/RBF/Funafuti_forecast/t_' + str(transect_labels[tt]) + '_results.csv'
        rbf_coeff_path = '../inundation/RBF/Funafuti_forecast/t_' + str(transect_labels[tt]) + '_rbf_coefficients_max_TWL_and_inun_ext.pkl'
        thresholds_path = '../inundation/RBF/Funafuti_forecast/t_' + str(transect_labels[tt]) + '_thresholds.csv'
